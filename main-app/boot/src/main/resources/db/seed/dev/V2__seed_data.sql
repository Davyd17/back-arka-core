...
-- CONTACTS
-- =========================
INSERT INTO contacts (name, last_name, position, email, is_active, user_id, company_id) VALUES
    -- Arka
    ('Carlos', 'Mendoza', 'CEO', 'carlos.mendoza@arka.com', true, null, 1),
    -- TechDistrib
    ('Andrés', 'Ramírez', 'Gerente Comercial', 'andres.ramirez@techdistrib.com', true, null, 2),
    ('Laura', 'Gómez', 'Ejecutiva de Ventas', 'laura.gomez@techdistrib.com', true, null, 2),
    -- ElectroMayorista
    ('Jorge', 'Herrera', 'Director Comercial', 'jorge.herrera@electromayorista.com', true, null, 3),
    -- Almacenes TechPro
    ('María', 'Castro', 'Gerente de Compras', 'maria.castro@techpro.com', true, null, 4),
    -- Distribuidora Digital Norte
    ('Felipe', 'Vargas', 'Jefe de Compras', 'felipe.vargas@digitalnorte.com', true, null, 5),
    -- Gadgets Express
    ('Valentina', 'Torres', 'Directora Comercial', 'valentina.torres@gadgetsexpress.com', true, null, 6);

-- =========================
-- ADDRESSES
-- =========================
INSERT INTO addresses (country, city, zip_code, address, type, is_active, contact_id) VALUES
    ('Colombia', 'Medellín', '050001', 'Calle 10 # 43E-31, El Poblado', 'EMPLOYEE', true, 1),
...
-- PHONE NUMBERS
-- =========================
INSERT INTO phone_numbers (country_code, extension, phone, is_active, contact_id) VALUES
    ('+57', null, '3001234567', true, 1),
...
INSERT INTO product_categories (name, slug) VALUES
    ('Computadores y Portátiles', 'computadores-y-portatiles'),
...
-- PRODUCTS
-- =========================
INSERT INTO products (sku, name, description, attributes, base_price, is_active, category_id) VALUES
...
-- WAREHOUSES
-- =========================
INSERT INTO warehouses (is_active, address_id) VALUES
    (true, 8),  -- Medellín warehouse
    (true, 9);  -- Bogotá warehouse

-- =========================
-- WAREHOUSE INVENTORY
-- =========================
INSERT INTO warehouses_inventory (stock, warehouse_id, product_id) VALUES
    -- Medellín warehouse
    (15, 1, 1),   -- ThinkPad E14
    (10, 1, 2),   -- HP ProBook
...
-- INVENTORY MOVEMENTS
-- =========================
INSERT INTO inventory_movements (type, quantity, previous_stock, new_stock, notes, product_id, employee_id, warehouse_inventory_id) VALUES
    ('IN', 15, 0, 15, 'Compra inicial ThinkPad E14 - Medellín', 1, 1, 1),
...
-- ORDERS
-- =========================
INSERT INTO orders (number, status, total_price, notes, type, company_id) VALUES
    ('ORD-2024-001', 'AUTHORIZED', 23050000.00, 'Pedido corporativo Q1 2024', 'SALES', 4),
    ('ORD-2024-002', 'PENDING', 8460000.00, 'Reposición de accesorios', 'SALES', 5),
    ('ORD-2024-003', 'PROCESSING', 15750000.00, 'Equipos para nueva sede', 'SALES', 6),
    ('ORD-2024-004', 'CANCELLED', 4200000.00, 'Cancelado por cliente', 'SALES', 4),
    ('PUR-2024-001', 'AUTHORIZED', 38500000.00, 'Compra a proveedor TechDistrib', 'PURCHASE', 2);

-- =========================
-- ORDER ITEMS
-- =========================
INSERT INTO order_items (order_id, product_id, quantity, unit_price_snapshot, total_price) VALUES
    ...
    (5, 1, 10, 3850000.00, 38500000.00); -- 10x ThinkPad
